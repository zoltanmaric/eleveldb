// -------------------------------------------------------------------
//
// BigsetClock.h: Declaration of the BigsetClock class and its associated
// helper classes; the BigsetClock class assists with parsing a bigset clock
// value stored in leveldb.
//
