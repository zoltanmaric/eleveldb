%% -------------------------------------------------------------------
%%
%% eleveldb_ets: ets table owner for eleveldb_conn
%%
...
%% eleveldb_conn module. Holding the ets table in an otherwise do-nothing
%% server avoids losing the table and its contents should an unexpected
%% error occur in eleveldb_conn if it were the owner instead. This module
%% is unit-tested as part of the eleveldb_conn module.
%% ====================================================================
